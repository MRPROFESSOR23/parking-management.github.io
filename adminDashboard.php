...
<?php 
    //Status
    $viewfirstfloor= "SELECT * FROM firstfloor_users ORDER BY ID";
    $viewSecThirdfloor= "SELECT * FROM sec_third_floor ORDER BY ID";
    $viewfirstfloorresult = mysqli_query($conn, $viewfirstfloor);
    $viewSecThirdfloorresult = mysqli_query($conn, $viewSecThirdfloor);
    $Firstfloor_rows = mysqli_num_rows($viewfirstfloorresult);
    $SecThirdfloor_rows = mysqli_num_rows($viewSecThirdfloorresult);
    $FirstSecThirdfloor_totalUsers = $Firstfloor_rows + $SecThirdfloor_rows;
    $totalAvailableSlots = 120 - $FirstSecThirdfloor_totalUsers;

    // status color
    // getting the parking slot
    $occupied = array();
...
?>
    ...
    <div class="container contents shadow-lg p-5 mt-5">
        <h1 class="text-center fw-bold mb-5">Status</h1>
        <div class="d-flex flex-wrap justify-content-center my-5">
            <div class="card me-2 mb-2 text-center" >
                <h5 class="card-header tw-bold text-white"  style="background-color: rgb(192, 17, 17);"><i class="fa-brands fa-buromobelexperte"></i> Available Slots</h5>
                <div class="card-body">
                    <h4 class="card-text"><?php echo $totalAvailableSlots ?></h4>
                </div>
            </div> <br>
            <div class="card me-2 mb-2 text-center" >
                <h5 class="card-header text-white" style="background-color: rgb(192, 17, 17);"><i class="fa-solid fa-motorcycle"></i> Two-Wheeled Vehicles</h5>
                <div class="card-body">
                    <h4 class="card-text"><?php echo $Firstfloor_rows ?></h4>
                </div>
            </div>
            <div class="card mb-2 text-center" >
                <h5 class="card-header text-white" style="background-color: rgb(192, 17, 17);"><i class="fa-solid fa-car-side"></i> Four-Wheeled Vehicles</h5>
                <div class="card-body">
                    <h4 class="card-text"><?php echo $SecThirdfloor_rows ?></h4>
                </div>
            </div>
            <div class="card ms-2 mb-2 text-center " >
                <h5 class="card-header tw-bold text-white" style="background-color: rgb(192, 17, 17);"><i class="fa-solid fa-users"></i> Total Users</h5>
                <div class="card-body">
                    <h4 class="card-text"><?php echo $FirstSecThirdfloor_totalUsers ?></h4>
                </div>
            </div>
        </div><br>

        <h1 class="fw-bold mb-3">Parking Area</h1><br>
