...
?>
        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarNavDropdown">
                <ul class="navbar-nav ms-auto">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active fw-bold fs-5" href="#"><i class="bi bi-truck "></i> PARKING AREA</a>
                    </li>
                    <li class="nav-item">
    ...
    <div class="container contents shadow-lg p-5 mt-5">
        ...
        <!-- <div class="float-end fw-bold">
            <span style="height: 15px; width: 15px; background-color: rgb(0, 255, 42); border-radius: 50%; border: 1px solid black; display:inline-block;"></span> Available <br>
            <span style="height: 15px; width: 15px; background-color: red; border-radius: 50%; border: 1px solid black; display:inline-block;"></span> Occuppied
        </div><br> -->
        <div class="float-end fw-bold">
