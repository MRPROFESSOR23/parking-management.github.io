<?php 
    ...
    $view_parkedIn = "SELECT R.ID, R.Username, R.Firstname, R.Lastname, R.Contact_No, R.Plate_No, V.Vehicle, R.Parking_Slot, S.status, R.Time_In, R.Date FROM registered_users AS R INNER JOIN vehicle AS V ON R.VehicleType_ID = V.VehicleType_ID INNER JOIN status AS S ON S.Status_ID = R.Status_ID WHERE S.status = 'In' ";
    $parkedInresult = mysqli_query($conn, $view_parkedIn);
?>
<!DOCTYPE html>
<html lang="en">
<head>
...
<body class="mainContainer">
        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarNavDropdown">
                <ul class="navbar-nav ms-auto">
                    <li class="nav-item">
                        <a class="nav-link fw-bold fs-5" aria-current="page" href="empDashboard.php"><i class="bi bi-speedometer2"></i> DASHBOARD</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link fw-bold fs-5" href="empFindvehicle.php"><i class="bi bi-search"></i> FIND VEHICLE</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link active fw-bold fs-5" href="userlist.php"><i class="fa-regular fa-rectangle-list"></i> USER LIST</a>
                    </li>
                </ul>
            </div>
        </div>
    ...
    <div class="container contents shadow-lg p-5 mt-5">
        <h1 class="text-center fw-bold mb-5">Parked In List</h1>
        <div class="container mt-5 mb-2">
            ...
            <table id="list" class="display p-2" style="width:100%"> 
                ...
                <tbody>
                    ...
                    <?php
                        while($row = mysqli_fetch_array($parkedInresult)) { ?>
                            <tr>
